  ...
  return (
    <>
      ...
      <div className="page-wrapper">
        {/* About Section */}
        <section
          className="bg-white text-[#174b82] py-12 px-4 md:px-8 lg:px-20"
          style={{ marginTop: "-4%" }}
        >
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold" style={{ marginBottom: "15px" }}>
              About us
            </h2>
        ...
        <section className="bg-gray-50 py-12 px-4 md:px-8 lg:px-20">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-[#174b82] mb-10">
              Meet The Team
            </h2>
            <br />
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  <img
                    ...
                    loading="lazy"
                  />
                  <h3 className="font-bold text-lg text-[#174b82]">
                    {member.name}
                  </h3>
