                        ...
                        <div className="services-wrapper">
                            ...
                            <div className="div-block-9">
                                ...
                                <div className="text-block-27">
                                    ...
                                    installations that maximize energy capture and sustainability for
                                    your projects.
                                </div>
                            </div>
                            <div className="div-block-10">
                                <div className="columns w-row">
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <h1 className="heading-39">
                                            <strong className="bold-text-9">Commercial Rooftop</strong>
                                        </h1>
                                        <div className="text-block-26">
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <h1 className="heading-40">
                                            <strong className="bold-text-7">Residential Rooftop</strong>
                                        </h1>
                                        <div className="text-block-26">
                                            Sun on Your Roof, Savings in Your Pocket. Residential solar.
                                            Easy install, clean energy for your home.
                                        </div>
                                    </div>
                                </div>
                                <div className="columns w-row">
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Our solar projects undergo rigorous peer review by industry
                                            experts. This ensures optimal design, maximizes efficiency,
                                            and delivers peace of mind for you.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                        <img
                                ...
                                >
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            We utilize independent engineering reviews on all projects,
                                            guaranteeing a reliable, code-compliant solar solution built
                                            to last. Trust the experts, choose Saanvi.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                        <img
                        ...
                        <div className="services-wrapper">
                            ...
                            <div className="div-block-9">
                                ...
                                <div className="text-block-27">
                                    ...
                                    construction management, ensuring quality, efficiency, and safety
                            ...
                            >
                                <div className="columns w-row">
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            ...
                                            homes, tailoring every detail to your unique style. Experience
                                            brings expertise, trust brings your dream home to life.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                        <img
                                        ...
                                        <h1 className="heading-42">
                                            <strong className="bold-text-12">Special Inspections</strong>
                                        </h1>
                                        <div className="text-block-26">
                                            Where function meets artistry. We design and construct
                                            captivating public art installations, fostering community
                                            engagement and transforming spaces. Let's collaborate to bring
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Building vibrant communities. We design and construct modern
                                            multifamily living spaces, prioritizing comfort,
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            ...
                                            that inspire productivity and functionality. From concept to
                                            completion, we optimize your workflow and create a space that
                                            reflects your brand.
                                        </div>
                                    </div>
                                </div>
                                <div className="columns w-row">
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            ...
                                            production and functionality. Our expertise ensures a durable,
                                            adaptable space that empowers your business to thrive.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                        <img
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Building Your Retail Success. We design and construct stunning
                                            retail spaces that optimize functionality and customer
                                            experience.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                ...
                                <div className="columns w-row">
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Streamlining Your Build. Our Construction Administration team
                                            keeps your project on track, on budget, and exceeding quality
                                            standards. Build with peace of mind.
                                        </div>
                                    </div>
                        ...
                        <div className="services-wrapper">
                            ...
                            <div className="div-block-9">
                                ...
                                <div className="text-block-27">
                                    ...
                                    projects. We ensure reliable, efficient, and future-proof telecom
                            ...
                            <div className="div-block-10">
                                <div className="columns w-row">
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Our comprehensive site surveys for telecommunication projects
                                            identify optimal tower placement, ensuring strong signal
                                            strength and a smooth build process.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                        <img
                                        ...
                                        <div className="text-block-26">
                                            Expert pile design provides a rock-solid foundation for your
                                            telecom tower on any terrain. Unwavering support, unwavering
                                            signal.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Our advanced mount mapping identifies the perfect placement
                                            for telecom equipment, maximizing signal strength and
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Expert tower analysis ensures your telecommunication tower is
                                            safe, reliable, and meets all code requirements. We maximize
                                            uptime, minimize.
                                        </div>
                                    </div>
                                </div>
                                <div className="columns w-row">
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            ...
                                            project, expediting approvals and keeping you informed every
                                            step of the way.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Our expert team tackles complex utility coordination, ensuring
                                            a smooth connection to the grid and avoiding delays. We power
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            We champion independent engineering reviews for your telecom
                                            project. This ensures an objective assessment, maximizing
                                    ...
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <h1 className="heading-80">
                                            <strong className="bold-text-7">Geotechnical Analysis</strong>
                                        </h1>
                                        <div className="text-block-26">
                                            Building a Strong Foundation for Your Tower. Expert
                                            geotechnical analysis ensures your telecom tower has a stable
                                            base, considering soil conditions and potential
                                            risks.pen_spark.
                                        </div>
                                    </div>
                                </div>
                                <div className="columns w-row">
                                    <div className="solarcoloma w-col w-col-3">
                                        ...
                                        <div className="text-block-26">
                                            Saanvi Structural soln streamlines telecom tower projects! Our
                                            expert team handles zoning approvals and creates detailed
                                            construction drawings, saving you time and ensuring a
                                            compliant build.
                                        </div>
                                    </div>
                                    <div className="solarcoloma w-col w-col-3">
                            ...
                            <div className="servicecomponents">
                                ...
                                <div className="flex-1/2">
                                    ...
                                    <div >
                                        ...
                                        ensure efficient resource allocation and accelerated project
                                ...
                                <div className="flex-1/2">
                                    ...
                                    <div >
                                        ...
                                        communication, ensuring successful project outcomes and
                                        long-term connectivity for your operations.
                                        <br />
                                    </div>
                                </div>
                            </div>
